...
import { Navbar, Footer, Section, Container, Badge, ContactForm, Button } from '@/components';
              ...
              <div className="lg:col-span-1 space-y-8">
                <div>
                  ...
                  <p className="text-gray-600 mb-6">
                    Have questions? We&apos;re here to help you achieve your business goals.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Pixenindiadigital@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+91 78277 17445</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-1">WhatsApp Us</h4>
                      <a 
                      ...
                      <p className="text-gray-500 text-sm mt-1">Chat on WhatsApp</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">B/459,Gali no.6, Khadda Colony, Jaitpur, South Delhi, Delhi 110044, India</p>
                    </div>
                  </div>
                </div>
          ...
          <Container size="xl">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <Button
                ...
                onClick={() => window.open('https://calendly.com/pixenindia/free-consultation', '_blank')}
              >
